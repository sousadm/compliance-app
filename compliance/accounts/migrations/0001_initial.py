    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_sac', models.BooleanField(blank=True, default=False, verbose_name='Atendimento SAC')),
                ('is_adm', models.BooleanField(blank=True, default=False, verbose_name='Administrativo')),
                ('is_fin', models.BooleanField(blank=True, default=False, verbose_name='Financeiro')),
                ('is_sup', models.BooleanField(blank=True, default=False, verbose_name='Suporte')),
                ('is_des', models.BooleanField(blank=True, default=False, verbose_name='Desenvolvimento')),
                ('is_consulta', models.BooleanField(blank=True, default=False, verbose_name='Desenvolvimento')),
